...
from java_mcp.tools.project_scanner import ProjectScanner
from java_mcp.tools.code_parser import CodeParser
from java_mcp.tools.dependency_graph import DependencyGraph, Edge
from java_mcp.tools.dependency_extractor import (
